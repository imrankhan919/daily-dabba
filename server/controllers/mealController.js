...
const getMeal = async (req, res) => {
    ...
    res.status(200).json({ _id: meal._id, name: meal.name, image: meal.image, description: meal.description, price: meal.price, isVeg: meal.isVeg, isActive: meal.isActive, rating: rating })
