                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between mb-2">
                                        <div>
                                            <h3 className="text-sm font-medium text-gray-900">Rahul Sharma</h3>
                                            <p className="text-sm text-gray-500">Dal Bati Churma • Order #ORD-001</p>
                                        </div>
                                        <div className="flex items-center">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Star key={star} className="h-4 w-4 text-yellow-400 fill-current" />
                                    ...
                                    <p className="text-gray-700">
                                        Excellent food quality! The Dal Bati Churma was authentic and reminded me of home.
                                        Delivery was quick and the food was still hot. Will definitely order again.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between mb-2">
                                        <div>
                                            <h3 className="text-sm font-medium text-gray-900">Priya Gupta</h3>
                                            <p className="text-sm text-gray-500">Poha Jalebi Combo • Order #ORD-002</p>
                                        </div>
                                        <div className="flex items-center">
                                            {[1, 2, 3, 4].map((star) => (
                                                <Star key={star} className="h-4 w-4 text-yellow-400 fill-current" />
                                    ...
                                    <p className="text-gray-700">
                                        Good taste and authentic flavors. The poha was well-prepared and jalebis were sweet.
                                        Only issue was slight delay in delivery, but overall satisfied with the meal.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center justify-between mb-2">
                                        <div>
                                            <h3 className="text-sm font-medium text-gray-900">Amit Patel</h3>
                                            <p className="text-sm text-gray-500">Indori Special Thali • Order #ORD-003</p>
                                        </div>
                                        <div className="flex items-center">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Star key={star} className="h-4 w-4 text-yellow-400 fill-current" />
                                    ...
                                    <p className="text-gray-700">
                                        Amazing variety in the thali! Everything was fresh and tasty. The portions were generous
                                        and the packaging was excellent. Best lunch delivery service in Indore.
                                    </p>
                                </div>
                            </div>
                        </div>
