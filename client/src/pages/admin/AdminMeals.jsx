        ...
        <div className="ml-64 flex-1">
            ...
            <header className="bg-white shadow-sm border-gray-500-b h-16 flex items-center justify-between px-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button onClick={handleModal} className="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 flex items-center space-x-2">
            ...
            {/* <MealModal /> */}
            <MealModal showModal={showModal} handleModal={handleModal} />
                    ...
                    <div className="p-6">
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">

                            {
                                allMeals.map(meal => {
                                    return (
                                        <AdminMealCard key={meal._id} meal={meal} handleModal={handleModal} />
                                    )
                                })
                            }
